#!/bin/bash
#SBATCH --output=/research/projects/zp128/OPH_Align/Dataset_Construction/Owt/log/build_WIKI_OPH.txt
#SBATCH --mem=200g

dataset=('/research/projects/zp128/dataset_tokenizedGbt2/tokenized_bin/sample_wiki.bin')
index_path=('/research/projects/zp128/OPH_Align/Dataset_Construction/Owt/tmp/tmp_index_OPH_1.bin')
