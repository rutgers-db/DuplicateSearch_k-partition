#!/bin/bash
#SBATCH --output=/research/projects/zp128/OPH_Align/Dataset_Construction/Owt/log/build_PAN11_OPH.txt
#SBATCH --mem=200g

dataset=('/research/projects/zp128/dataset_tokenizedGbt2/tokenized_bin/PAN11_external_source.bin')
index_path=('/research/projects/zp128/OPH_Align/Dataset_Construction/Owt/tmp/tmp_indexOPH.bin')
