...
int main(int argc, char *argv[]) {
    ...
    char out_file[100];
    sprintf(out_file, "ExpResults/OPH_%s_n%d_l%d_k%d_t%.1lf_q%d.txt", src_file.substr(src_file.rfind('/') + 1, src_file.rfind('.') - src_file.rfind('/') - 1).c_str(), doc_num, doc_length, k, threshold, queryNum);
