...
plot "filtered_data.txt" u 1:3 w linespoints pt 1 ps 2 lw 5  t "KMS-Arb",\
     "" u 1:4 w linespoints pt 2 ps 2 lw 5  t "OPH-Arb",\
     "" u 1:5 w linespoints pt 3 ps 2 lw 5  t "KMS-Pos",\
     "" u 1:6 w linespoints pt 4 ps 2 lw 5  t "OPH-Pos",\
...
plot "filtered_data.txt" u 1:3 w linespoints pt 1 ps 2 lw 5  t "KMS-Pos",\
     "" u 1:4 w linespoints pt 2 ps 2 lw 5  t "OPH-Pos",\
     "" u 1:5 w linespoints pt 3 ps 2 lw 5  t "KMS-Int",\
     "" u 1:6 w linespoints pt 4 ps 2 lw 5  t "OPH-Int",\
...
plot "filtered_data.txt" u 1:3 w linespoints pt 1 ps 2 lw 5  t "KMS-Int",\
     "" u 1:4 w linespoints pt 2 ps 2 lw 5  t "OPH-Int",\
     "" u 1:5 w linespoints pt 3 ps 2 lw 5  t "KMS-Seg",\
     "" u 1:6 w linespoints pt 4 ps 2 lw 5  t "OPH-Seg",\
...
plot "../data/pan_avg_time_vary_theta_filter.txt" u 1:3 w linespoints pt 1 ps 2 lw 5  t "None",\
     "../data/pan_avg_time_vary_theta_filter.txt" u 1:4 w linespoints pt 2 ps 2 lw 5  t "WFilter",\
     "../data/pan_avg_time_vary_theta_filter.txt" u 1:5 w linespoints pt 3 ps 2 lw 5  t "WFilter+RFilter",\

set yrange[0.0000001:500]
set output "../figure/wiki_avg_time_vary_theta_filter.eps"
plot "../data/wiki_avg_time_vary_theta_filter.txt" u 1:3 w linespoints pt 1 ps 2 lw 5  t "None",\
     "../data/wiki_avg_time_vary_theta_filter.txt" u 1:4 w linespoints pt 2 ps 2 lw 5  t "WFilter",\
     "../data/wiki_avg_time_vary_theta_filter.txt" u 1:5 w linespoints pt 3 ps 2 lw 5  t "WFilter+RFilter",\

set output "../figure/owt_avg_time_vary_theta_filter.eps"
plot "../data/owt_avg_time_vary_theta_filter.txt" u 1:3 w linespoints pt 1 ps 2 lw 5  t "None",\
     "../data/owt_avg_time_vary_theta_filter.txt" u 1:4 w linespoints pt 2 ps 2 lw 5  t "WFilter",\
     "../data/owt_avg_time_vary_theta_filter.txt" u 1:5 w linespoints pt 3 ps 2 lw 5  t "WFilter+RFilter",\