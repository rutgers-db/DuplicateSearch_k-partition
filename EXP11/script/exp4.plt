...
plot "../data/owt_index_size_vary_docsnum.txt" u ($1):($3):(0.3) w boxes fs pattern 7 t "Filter 1+2",\

set xtics ("0.36M" 0, "0.73M" 1, "1.46M" 2, "2.92M" 3)
set output "../figure2/wiki_index_size_vary_docsnum.eps"
plot "../data/wiki_index_size_vary_docsnum.txt" u ($1):($3):(0.3) w boxes fs pattern 7 t "Filter 1+2",\
...
plot "../data/owt_index_time_vary_docsnum.txt" u ($1):($3):(0.3) w boxes fs pattern 7 t "Filter 1+2",\

set xtics ("0.36M" 0, "0.73M" 1, "1.46M" 2, "2.92M" 3)
set output "../figure2/wiki_index_time_vary_docsnum.eps"
plot "../data/wiki_index_time_vary_docsnum.txt" u ($1):($3):(0.3) w boxes fs pattern 7 t "Filter 1+2",\
...
plot "../data/owt_query_time_vary_docsnum.txt" u ($1):($3):(0.3) w boxes fs pattern 7 t "Filter 1+2",\

set xtics ("0.36M" 0, "0.73M" 1, "1.46M" 2, "2.92M" 3)
set output "../figure2/wiki_query_time_vary_docsnum.eps"
plot "../data/wiki_query_time_vary_docsnum.txt" u ($1):($3):(0.3) w boxes fs pattern 7 t "Filter 1+2",\