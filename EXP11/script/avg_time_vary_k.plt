...
plot "../data/pan_avg_time_vary_k.txt" u 1:3 w lines lw 3  t "KMS-Arb",\
     "../data/pan_avg_time_vary_k.txt" u 1:4 w lines lw 3  t "OPH-Arb",\
     "../data/pan_avg_time_vary_k.txt" u 1:5 w lines lw 3  t "KMS-Pos",\
     "../data/pan_avg_time_vary_k.txt" u 1:6 w lines lw 3  t "OPH-Pos",\
...
plot "../data/pan_avg_time_vary_k.txt" u 1:7 w lines lw 3  t "KMS-All",\
     "../data/pan_avg_time_vary_k.txt" u 1:8 w lines lw 3  t "OPH-All",\
     "../data/pan_avg_time_vary_k.txt" u 1:9 w lines lw 3  t "KMS-Longest",\
     "../data/pan_avg_time_vary_k.txt" u 1:10 w lines lw 3  t "OPH-Longest",\
...
plot "../data/pan_avg_time_vary_k.txt" u 1:5 w lines lw 3  t "KMS-Int",\
     "../data/pan_avg_time_vary_k.txt" u 1:6 w lines lw 3  t "OPH-Int",\
     "../data/pan_avg_time_vary_k.txt" u 1:11 w lines lw 3  t "KMS-Seg",\
     "../data/pan_avg_time_vary_k.txt" u 1:12 w lines lw 3  t "OPH-Seg",\