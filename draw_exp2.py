    ...
    for file_name in os.listdir('ExpResults/Exp_CW_query/'):
        if method in file_name and dataset in file_name and \
           ...
           ('t'+str(theta)+'_' in file_name or 't'+str(theta)+'.' in file_name):
            return 'ExpResults/Exp_CW_query/' + file_name
        ...
        for k in ktics:
            ...
            with open(file_name, 'r') as f:
                ...
                while True:
                    ...
                    results = int(f.readline())
                    querytime = float(f.readline())
                    if collided in dataKMINS:
                        dataKMINS[collided].append(querytime)
                    else:
                        dataKMINS[collided] = [querytime]
        ...
        for k in ktics:
            ...
            with open(file_name, 'r') as f:
                ...
                while True:
                    ...
                    results = int(f.readline())
                    querytime = float(f.readline())
                    if results in dataKMINS:
                        dataKMINS[results].append(querytime)
                    else:
                        dataKMINS[results] = [querytime]
